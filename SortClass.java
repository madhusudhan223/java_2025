...
//    ---> you want to sort elements based on multiple field values.
    // --> when you dont want to keep your comparable logic inside of your class.

    public static class ListInterFaceDemo {
    ...
    //        Collections.sort(customers);
            Collections.sort(customers, new ObjectList.EmailComparator());
